...
export default function Footer() {
  ...
  return (
    <div
      id="footer"
      className="dark:bg-dark-background bg-background text-primary dark:text-white px-7 leading-5 flex flex-col justify-center"
    >
      ...
      <div className="border-t dark:border-white border-primary text-center">
